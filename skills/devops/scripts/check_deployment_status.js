...
const toolName = "check_deployment_status";
...
function main() {
    ...
    const npxArgs = ["--yes", "@toolbox-sdk/server@latest", "--log-level", "error", ...configArgs, "invoke", toolName, "--user-agent-metadata", userAgent, ...processedArgs];
